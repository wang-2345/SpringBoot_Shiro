...
@EnableJpaRepositories(
    ...
    basePackages = {"com.github.wangChen2345.springboot_shiro.sys.repository"}) // 设置Repository所在位置
public class PrimaryConfig {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(
    ...
    return builder
        ...
        .packages("com.github.wangChen2345.springboot_shiro.sys.entiy") // 设置实体类所在位置
